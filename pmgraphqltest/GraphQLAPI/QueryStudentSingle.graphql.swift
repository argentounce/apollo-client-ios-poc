...
public final class QueryStudentSingleQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query QueryStudentSingle($studentId: ID!) {
  ...
  public let operationName: String = "QueryStudentSingle"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("student", arguments: ["id": GraphQLVariable("studentId")], type: .object(Student.selections)),
      ]
    }
